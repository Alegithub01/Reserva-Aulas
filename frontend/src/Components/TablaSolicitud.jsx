...
function TablaSolicitudes() {
  ...
  const columnas = [
    ...
    { field: 'servicios', headerName: 'Servicios solicitados', width: 190, headerAlign: 'center', align: 'center', },
    { field: 'detalles', headerName: 'Detalles de solicitud', width: 190, headerAlign: 'center', align: 'center', },
    {
      field: 'acciones',
      type: 'actions',
      headerName: 'Acciones',
